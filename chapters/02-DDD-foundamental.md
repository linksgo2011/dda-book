...
![DDD-v5](../images/02-DDD-foundamental/ddd-v5.png)
...
![ddd-v6](../images/02-DDD-foundamental/ddd-v6.png)
...
![数据库设计](../images/02-DDD-foundamental/database-design.png)
...
![API 设计](../images/02-DDD-foundamental/api-design.png)

值对象没有 ID，应该只能依附于某个实体的路径下做更新操作。

![API 设计 v2](../images/02-DDD-foundamental/api-design-v2.png)
...
![对象设计](../images/02-DDD-foundamental/objects-design.png)
...
![三层架构对比](../images/02-DDD-foundamental/ddd-vs.png)

我们将 DDD 的代码架构展开，可以看到更为细节的内容。 DDD 代码实现上需要 `Repository`、`Factory` 等概念，但这些是可选的，我们在后面具体讲代码结构的部分再阐述。

![单体DDD架构](../images/02-DDD-foundamental/ddd-mono.png)

我们再来看，DDD 的单体应用架构映射到微服务架构下会是怎么样的。

![单体到微服务](../images/02-DDD-foundamental/mono-micro-service.png)
